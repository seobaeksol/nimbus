...
const panelSlice = createSlice({
  ...
  reducers: {
    ...
    navigateToPath: (state, action: PayloadAction<{ panelId: string; path: string }>) => {
    ...
    setFiles: (state, action: PayloadAction<{ panelId: string; files: FileInfo[] }>) => {
    ...
    setLoading: (state, action: PayloadAction<{ panelId: string; isLoading: boolean }>) => {
    ...
    setError: (state, action: PayloadAction<{ panelId: string; error: string | null }>) => {
    ...
    selectFiles: (state, action: PayloadAction<{ panelId: string; fileNames: string[]; toggle?: boolean }>) => {
    ...
    setViewMode: (state, action: PayloadAction<{ panelId: string; viewMode: Panel['viewMode'] }>) => {
    ...
    setSorting: (state, action: PayloadAction<{ panelId: string; sortBy: Panel['sortBy']; sortOrder?: Panel['sortOrder'] }>) => {
      ...
      if (state.panels[panelId]) {
        ...
        if (sortOrder) {
          ...
          state.panels[panelId].sortOrder = 
            state.panels[panelId].sortBy === sortBy && state.panels[panelId].sortOrder === 'asc' 
              ? 'desc' : 'asc';
        }
      }
    },
